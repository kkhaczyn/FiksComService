...
namespace FiksComService.Migrations
{
    ...
    [Migration("20240526175050_AddingNewTableComponentTypeMigration")]
    partial class AddingNewTableComponentTypeMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FiksComService.Models.Database.Component", b =>
                {
                    ...
                    b.HasIndex("ComponentTypeCode");

                    b.ToTable("Components");
                });

            modelBuilder.Entity("FiksComService.Models.Database.ComponentType", b =>
                {
            ...
            modelBuilder.Entity("FiksComService.Models.Database.Invoice", b =>
                {
            ...
            modelBuilder.Entity("FiksComService.Models.Database.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7f0d7223-1519-490c-8a4d-76f92eb02474",
                            Email = "adminTest@interia.pl",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMINTEST@INTERIA.PL",
                            NormalizedUserName = "ADMINEK",
                            PasswordHash = "AQAAAAIAAYagAAAAEPp/fbESSfpQFaSkDiomNuUCiYUOUjWfc3R9dA+h+PVV/zAYrGtLPCBkvzQuXwZjtQ==",
                            PhoneNumber = "758675867",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "5b4ea04b-b2ae-4b0b-ab7c-5bafb4bd921f",
            ...
            modelBuilder.Entity("FiksComService.Models.Database.Component", b =>
                {
                    b.HasOne("FiksComService.Models.Database.ComponentType", "ComponentType")
                        .WithMany()
                        .HasForeignKey("ComponentTypeCode")
